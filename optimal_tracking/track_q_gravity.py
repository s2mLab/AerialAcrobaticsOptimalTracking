...
def prepare_ocp(biorbd_model, final_time, number_shooting_points, q_ref, qdot_ref, tau_init, xmin, xmax, min_g, max_g, min_torque_diff=False):
...
if __name__ == "__main__":
    ...
    # --- Save --- #
    save_path = 'solutions/track_q_gravity/'
